...
var data = [
  {
    postId: 1,
    profilePic:
      "http://images.unsplash.com/photo-1529665253569-6d01c0eaf7b6?ixlib=rb-1.2.1&q=80&fm=jpg&crop=entropy&cs=tinysrgb&w=1080&fit=max&ixid=eyJhcHBfaWQiOjEyMDd9",
    autherName: "Tass",
    createdAt: "Nov 11, 2019 | 3:32 PM",
    body:
      "If I found out someone were using this on me, I’d disassociate with them. This is overreaching and creepy."
  },
  {
    postId: 1,
    profilePic:
  ...
  },
  {
    postId: 2,
    profilePic:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQQJR6BqqLi6y004j182y-DQqexGNssQn5AHlZ7DUBXpYQe3H7P",
    autherName: "nazih",
    createdAt: "Nov 11, 2019 | 3:52 PM",
